...
module.exports = function(json_shops_confs) {

  //var json_shops_confs = require('./config/sync_shops.js');
  var json_shops_confs = json_shops_confs;
  ...
  return heritage = {
    ...
    parse_info_filter: function (sku, cb) {
    ...
    splitDescriptionData: function (rawDescription) {
      var description = {};
    ...
    set_render_parameter: function (data, cb) {
    ...
    get_products: function (url_string, cb) {
