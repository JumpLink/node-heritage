...
var getSKUFromString = function (url_string) {
  var start_string = "l_sPartCode=";
  var end_string = "&sToken=";

  var start_index = url_string.indexOf(start_string)+start_string.length;
  var end_index = url_string.indexOf(end_string);

  var sku_string = url_string.substring(start_index, end_index);
  console.log(sku_string);
  return sku_string.split(',');
}
...
if(typeof exports == 'undefined'){
  ...
  module.exports.getSKUFromString = getSKUFromString;
}